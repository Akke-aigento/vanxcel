...
const Phase4 = ({ t }: { t: (k: string) => string }) => (
  <svg viewBox="0 0 680 380" className="w-full h-auto max-w-[680px]" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x={290} y={360} textAnchor="middle" fontSize={9} fill={S.red}>{t("configurator.illustRedCable", { size: "16mm²" })}</text>
    <text x={400} y={360} textAnchor="middle" fontSize={9} fill={S.darkGrey}>{t("configurator.illustBlackCable", { size: "16mm²" })}</text>
